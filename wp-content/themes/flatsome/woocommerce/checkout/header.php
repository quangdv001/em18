    ...
    <div class="page-title-inner flex-row medium-flex-wrap container">
        <div class="flex-col flex-grow medium-text-center">
            <nav class="breadcrumbs heading-font checkout-breadcrumbs text-center h2 strong">
                ...
                <a href="<?php echo $woocommerce->cart->get_checkout_url(); ?>" class="<?php echo flatsome_checkout_breadcrumb_class('checkout') ?>"><?php _e('Thanh Toán', 'flatsome'); ?></a>
                <span class="divider hide-for-small"><?php echo get_flatsome_icon('icon-angle-right');?></span>
                <a href="#" class="no-click <?php echo flatsome_checkout_breadcrumb_class('order-received'); ?>"><?php _e('Hoàn Thành', 'flatsome'); ?></a>
            </nav>
        </div><!-- .flex-left -->
    </div><!-- flex-row -->
</div><!-- .page-title -->
